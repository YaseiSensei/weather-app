...
/* https://api.openweathermap.org/data/2.5/weather?lat=${currentCity.lat}&lon=${currentCity.lon}${part}${apiKey}&units=metric
`api.openweathermap.org/data/2.5/forecast/daily?lat=${currentCity.lat}&lon=${currentCity.lon}&cnt=7${apiKey}&units=metric` */
